...
var Signin = function (_NTechnology) {
    _inherits(Signin, _NTechnology);
...
var Signup = function (_NTechnology) {
    _inherits(Signup, _NTechnology);
...
var NTechnology = function (_TinyEmitter) {
    _inherits(NTechnology, _TinyEmitter);

    function NTechnology() {
        _classCallCheck(this, NTechnology);

        var _this = _possibleConstructorReturn(this, (NTechnology.__proto__ || Object.getPrototypeOf(NTechnology)).call(this));
